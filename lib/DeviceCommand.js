...
class DeviceCommand {
   ...
   */
  fetchCommandStatus(){
    return this.api.callAuthorized(this.api.getCommand, this.deviceId, this.id)
      .then(command => {
   ...
   */
  save(){
    return this.api.callAuthorized(this.api.updateCommand, this.deviceId, this.id, this);
  }
