...
class Device {
   ...
   */
  save(){
    return this.api.callAuthorized(this.api.saveDevice, this.id, this);
  }
   ...
   */
  getCommands(filter){
    return this.api.callAuthorized(this.api.getDeviceCommands, this.id, filter)
  ...
  getNotifications(filter){
    return this.api.callAuthorized(this.api.getDeviceNotifications, this.id, filter)
  ...
  sendCommand(command, parameters, updateSubscriber){
    return this.api.callAuthorized(this.api.createDeviceCommand, this.id, { command, parameters })
      .then(createdCommand => {
  ...
  sendNotification(notification, parameters){
    return this.api.callAuthorized(this.api.createDeviceNotification, this.id, { notification, parameters })
