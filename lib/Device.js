...
class Device {
   ...
   */
  save(){
    return api.callAuthorized(api.saveDevice, this.id, this);
  }
  ...
  _pollCommands(commandFilter){
    ...
    .then(updatedFilter => api.callAuthorized(api.getDeviceCommandsPoll, this.id, updatedFilter))
    .then(commands => {
  ...
  _pollNotifications(notificationFilter){
    return api.getInfo()
      ...
      .then(updatedFilter => api.callAuthorized(api.getDeviceNotificationPoll, this.id, updatedFilter))
      .then(notifications => {
