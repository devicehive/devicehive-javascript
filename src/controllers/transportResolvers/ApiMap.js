...
apiMap.set(API.getDevice, { http: { method: 'GET', uri: '/device/{deviceId}'}, ws: { action: 'device/get' } });
apiMap.set(API.addDevice, { http: { method: 'PUT', uri: '/device/{deviceId}'}, ws: { action: 'device/save', bodyKey: 'device' } });
apiMap.set(API.deleteDevice, { http: { method: 'DELETE', uri: '/device/{deviceId}'}, ws: { action: 'device/delete' } });
...
apiMap.set(API.getDeviceType, { http: { method: 'GET', uri: '/devicetype/{deviceTypeId}'}, ws: { action: 'devicetype/get' } });
apiMap.set(API.addDeviceType, { http: { method: 'POST', uri: '/devicetype'}, ws: { action: 'devicetype/insert', bodyKey: 'deviceType' } }); 
apiMap.set(API.updateDeviceType, { http: { method: 'PUT', uri: '/devicetype/{deviceTypeId}'}, ws: { action: 'devicetype/update', bodyKey: 'deviceType' } });
apiMap.set(API.deleteDeviceType, { http: { method: 'DELETE', uri: '/devicetype/{deviceTypeId}'}, ws: { action: 'devicetype/delete' } });
...
apiMap.set(API.getNotification, { http: { method: 'GET ', uri: '/device/{deviceId}/notification/{notificationId}'}, ws: { action: 'notification/get' } });
...
apiMap.set(API.getNetwork, { http: { method: 'GET', uri: '/network/{networkId}'}, ws: { action: 'network/get' } });
apiMap.set(API.addNetwork, { http: { method: 'POST', uri: '/network'}, ws: { action: 'network/insert', bodyKey: 'network' } }); 
apiMap.set(API.updateNetwork, { http: { method: 'PUT', uri: '/network/{networkId}'}, ws: { action: 'network/update', bodyKey: 'network' } });
apiMap.set(API.deleteNetwork, { http: { method: 'DELETE', uri: '/network/{networkId}'}, ws: { action: 'network/delete' } });
...
apiMap.set(API.getUser, { http: { method: 'GET', uri: '/user/{userId}'}, ws: { action: 'user/get' } });
apiMap.set(API.addUser, { http: { method: 'POST', uri: '/user'}, ws: { action: 'user/insert', bodyKey: 'user' } });  
apiMap.set(API.updateUser, { http: { method: 'PUT', uri: '/user/{userId}'}, ws: { action: 'user/update', bodyKey: 'user' } });
apiMap.set(API.deleteUser, { http: { method: 'DELETE', uri: '/user/{userId}'}, ws: { action: 'user/delete' } });
...
apiMap.set(API.getUserNetwork, { http: { method: 'GET', uri: '/user/{userId}/network/{networkId}'}, ws: { action: 'user/getNetwork' } });
apiMap.set(API.assignNetwork, { http: { method: 'PUT', uri: '/user/{userId}/network/{networkId}'}, ws: { action: 'user/assignNetwork' } });
apiMap.set(API.unassignNetwork, { http: { method: 'DELETE', uri: '/user/{userId}/network/{networkId}'}, ws: { action: 'user/unassignNetwork' } });
